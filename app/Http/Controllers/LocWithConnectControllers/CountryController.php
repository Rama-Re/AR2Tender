...
class CountryController extends Controller
{
    ...
    private static $countryArray = array(
        ...
        'AX'=>array('name'=>'Åland Islands','code'=>'358'),
        ...
        'BQ'=>array('name'=>'Bonaire','code'=>'599'),
        ...
        'RE'=>array('name'=>'Réunion','code'=>'262'),
        ...
        'SX'=>array('name'=>'Sint Maarten','code'=>'599'),*/
        'SY'=>array('name'=>'SYRIAN ARAB REPUBLIC','code'=>'963'),
        /*'SZ'=>array('name'=>'SWAZILAND','code'=>'268'),
        'TC'=>array('name'=>'TURKS AND CAICOS ISLANDS','code'=>'1649'),
        'TD'=>array('name'=>'CHAD','code'=>'235'),
        'TF'=>array('name'=>'French Southern and Antarctic Lands','code'=>'590'),
    ...
    public static function index(){
        ...
        return $generalTrait->returnData("countries",Country::get());
    }
    public static function get_countries_names(){
        return array_column(self::$countryArray, 'name');
    }
    public static function get_countries_phone_code(){
        return array_column(self::$countryArray, 'code');
    }
    public static function get_countries_alias(){
        return array_keys(self::$countryArray);
    }
